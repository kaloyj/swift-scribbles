...
class Blog
{
    ...
    public function setFeaturedPhoto($featuredPhoto): self
    {
    ...
    public function getFeaturedContent(): ?string
    {
        return $this->featuredContent;
    }

    public function setFeaturedContent(?string $featuredContent): self
    {
