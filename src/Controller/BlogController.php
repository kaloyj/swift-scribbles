...
class BlogController extends AbstractController
{
    ...
    public function processCreateBlog(Request $request)
    {
        ...
        $form = $this->createForm(BlogType::class, $created_blog);
        //$created_blog->setFeaturedPhoto();

        $file = $request->files->get('blogFeaturedPhoto');
        if($file){
        ...
        $created_blog->setFeaturedPhoto($fileName);
    ...
    /**
     * @Route("/blog/{blog_id}", name="detail_blog")
     */
    public function detail($blog_id)
    {
        $blog_repository = $this->getDoctrine()->getRepository(Blog::class);
        $blog_details = $blog_repository->find($blog_id);
